  ...
  return (
    <>
      <PropertiesSheet
        ...
        subtitle={multipleSelected ? `${selectedNodes.length} nodes selected` : customName || technology.name}
        onClose={deselectAll}
      >
        ...
        {/* Outside the sheet: its transform would re-anchor these fixed overlays, and inert would block them */}
        {editModalOpen && (
          <CustomTechModal
